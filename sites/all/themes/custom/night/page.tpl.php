...
if ($current_path == $base_url.'/node/3' || $current_path == $base_url.'/about') {
  print render($page['content']);
}
elseif ($current_path == $base_url.'/node/2' || $current_path == $base_url.'/home') {
?>
<?php if ($page['content']): ?>
  <div class="container-fluid content-wrapper">
    <div class="col-md-3 no-mar"></div>
...
<div class="container-fluid no-pad">
  <div class="col-md-7 no-pad">
    <?php if ($page['content']): ?>
      <div class="abt-page-img">
        <?php print render($page['slides']); ?>
      </div>
    <?php endif;?>
  </div>    
  <div class="col-md-5">
    <h2 class="abt-page-head">About skywalks</h2>
    <p class="abt-page-para">
